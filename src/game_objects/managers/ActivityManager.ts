...
export default class ActivityManager {
    ...
    update ( delta: number ) {
        ...
        if ( this.CurrentActivity.Type == "Cutting Oak Tree" ) {
            ...
            this.scene.DataManager.GameData.Characters[0].Skills.Forestry.XP += 5;
        } else if ( this.CurrentActivity.Type == "Harvesting Marigold" ) {
            ev.message = "+1 Marigold";
            ev.sprite1 = "flowers";
            ev.sprite2 = 32;
            this.scene.Inventory.AddItem("marigold", 1);
            this.scene.DataManager.GameData.Characters[0].Skills.Botany.XP += 5;
            ...
            this.scene.DataManager.GameData.Characters[0].Skills.Mining.XP += 5;
            ...
            this.scene.DataManager.GameData.Characters[0].Skills.Fishing.XP += 5;
        }
