// Characters
export const HumanOperativeSpritesheet: string = require('./assets/images/own/Human-Operative.png');
export const HumanOperativeJSON: string = require('./assets/images/own/Human-Operative.json');

// Logo
export const Logo: string = require('./assets/images/logo.png');

// Fonts
export const Augusta: string = require('./assets/fonts/Augusta.ttf');
export const Dungeon: string = require('./assets/fonts/DungeonFont.ttf');
export const Flesh: string = require('./assets/fonts/Fleshandblood-MVA5x.ttf');
...
export const LeatherDark: string = require('./assets/images/admurin/LeatherDark.png');
...
export const WoodTile: string = require('./assets/images/wood-tile.jpg');
export const Items: string = require('./assets/images/items.png');
...
export const DartVolley: string = require('./assets/images/DartVolley.png');
...
export const WillowvaleNorthMap: string = require('./assets/maps/WillowvaleNorth.png');

// particles
export const BloodOne: string = require('./assets/images/Blood1.png');
export const BloodTwo: string = require('./assets/images/Blood2.png');
export const BloodArcaneOne: string = require('./assets/images/BloodArcane1.png');
...
export const RA_Crypt: string = require('./assets/images/rogue-adventure/RA_Crypt.png');
export const RA_Graveyard: string = require('./assets/images/rogue-adventure/RA_Graveyard.png');
export const RA_Ground_Tiles = require('./assets/images/rogue-adventure/RA_Ground_Tiles.png');
export const RA_Jungle: string = require('./assets/images/rogue-adventure/RA_Jungle.png');
export const RA_Jungle_Animation: string = require('./assets/images/rogue-adventure/RA_Jungle_Animation.png');
...
export const JournalImage: string = require('./assets/images/Journal.png');
export const JournalJSON: string = require('./assets/images/Journal.json');

export const Rain: string = require('./assets/images/Rain.png');
export const RainSpritesheet: string = require('./assets/images/RainEnd.png');
