...
// Spritesheet Indexer: https://nefd.github.io/spritesheet-indexer/
// Tiled: https://www.mapeditor.org
// Piskel: https://www.piskelapp.com
// Phaser: https://phaser.io
// Phaser Nav Mesh Plugin: https://github.com/mikewesthad/navmesh
// Quad Tree TS: https://github.com/timohausmann/quadtree-ts/
// Normal Map Online: https://cpetry.github.io/NormalMap-Online/
// Font: Mooli https://fonts.google.com/specimen/Mooli
...
export const RedBar: string = require('./images/redbar.png');
export const GreenBar: string = require('./images/greenbar.png');
export const YellowBar: string = require('./images/yellowbar.png');
export const Panel: string = require('./images/panel.png');
export const PanelSmall: string = require('./images/panel-small.png');
export const Button: string = require('./images/button.png');
export const ButtonDown: string = require('./images/button_pressed.png');
...
export const BloodTwo: string = require('./images/Blood2.png');
...
export const Warehouse: string = require('./images/buildings/Warehouse.png');
export const Inn: string = require('./images/buildings/Inn.png');
export const Farm: string = require('./images/buildings/Farm.png');
export const Mine: string = require('./images/buildings/Mine.png');
export const TradePost: string = require('./images/buildings/TradePost.png');
export const LoggingCamp: string = require('./images/buildings/LoggingCamp.png');
