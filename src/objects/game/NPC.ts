...
export default class NPC extends Phaser.Physics.Arcade.Sprite {
    ...
    SetCharacterType ( name: string ) {
        console.log("Setting character type to: ", name);
        const data = EnemyData[name as keyof typeof EnemyData];
        if (data) {
            this.Name = data.Name;
            this.WalkAnimation = data.WalkAnimation;
            this.setTexture(data.Spritesheet, data.SpritesheetFrame);
            this.Type = data.Type;
            ...
            this.Defence_Pierce = data.Defence_Pierce;
            this.Defence_Impact = data.Defence_Impact;
            this.Defence_Slash = data.Defence_Slash;
            this.Defence_Fire = data.Defence_Fire;
            this.Defence_Cold = data.Defence_Cold;
            this.Defence_Lightning = data.Defence_Lightning;
            this.Defence_Poison = data.Defence_Poison;
            this.Defence_Arcane = data.Defence_Arcane;
            this.Defence_True = data.Defence_True;
            this.Defence_Bleed = data.Defence_Bleed;
            this.Defence_Radiant = data.Defence_Radiant;
            this.Defence_Corruption = data.Defence_Corruption;
            this.Defence_Sonic = data.Defence_Sonic;
            // If Level/Modifiers were pre-loaded from Tiled properties, apply them now
            if ( this.Level ) this.ApplyLevel(this.Level);
            if ( this.Modifiers?.length ) this.ApplyModifiers(this.Modifiers);
        }
    }
